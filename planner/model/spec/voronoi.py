...
from ..voro_new.fortune_data import Line
...
class Voronoi:
    def __init__(self, lines):
        ...
        self.lines = [Line(line, [self.x0, self.x1, self.y0, self.y1]) for line in lines]
        for line in self.lines:
            [self.points.push(p) for p in line.get_points()] # seed pq
